...
public class RemoveGreaterCommand implements Command {
    ...
    public void execute(String[] args) throws CommandExecutionException {
        try {
            System.out.println("Enter data for comparison route (remove elements greater than this):");
            ...
            System.out.println("Removed " + removedIds.size() + " elements greater than the specified route.");
        } catch (IllegalArgumentException e) {
            throw new CommandExecutionException("Error in remove_greater: " + e.getMessage());
        }
    }

    @Override
    public String getDescription() {
        return "Remove all elements that are greater than the specified element.";
    }
}